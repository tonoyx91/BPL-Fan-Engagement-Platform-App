...
class AdminFixturePage extends StatefulWidget {
  final String email;

  const AdminFixturePage({super.key, required this.email});

  @override
  _FixturePageState createState() => _FixturePageState();
}

class _FixturePageState extends State<AdminFixturePage> {
  ...
  Future<void> _fetchFixtures() async {
    try {
      final response = await http.get(Uri.parse(
          'https://bpl-fan-engagement-platform-app.onrender.com/api/auth/get-fixtures')); // Replace <your-ip-address>
        ...
        child: ListView(
          children: [
            ...
            _buildDrawerItem(
              ...
              text: 'HomePage',
              onTap: () {
                Get.off(() => AdminHomepage(email: widget.email));
              },
            ),
            _buildDrawerItem(
